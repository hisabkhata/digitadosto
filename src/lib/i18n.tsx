...
const dict = {
  bn: {
    ...
    createCategory: "নতুন যোগ করুন",
    image: "ছবি",
    uploadImage: "ছবি আপলোড",
    removeImage: "ছবি সরান",
    searchCategory: "ক্যাটাগরি খুঁজুন বা টাইপ করুন",
    catGrocery: "মুদি",
    catRice: "চাল-ডাল",
    catOilSpice: "তেল-মসলা",
    catSnacks: "বিস্কুট-চিপস",
    catBeverage: "পানীয়",
    catDairy: "দুগ্ধজাত",
    catToiletries: "প্রসাধনী",
    catBakery: "বেকারি",
    catOthers: "অন্যান্য",
    uploading: "আপলোড হচ্ছে…",
    monthlyRevenue: "এই মাসের আয়",
    monthlyProfit: "এই মাসের মুনাফা",
  ...
  en: {
    ...
    searchCategory: "Search or type a category",
    catGrocery: "Grocery",
    catRice: "Rice & Lentils",
    catOilSpice: "Oil & Spices",
    catSnacks: "Snacks",
